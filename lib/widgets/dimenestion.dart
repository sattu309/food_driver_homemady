...
class AddSize {
  ...
  static double padding05 = padding15 - padding10;
  ...
  static double size65 = size50 + size15;
  ...
  static double size700 = size250 + size250 + size200;
  static double size900 = size700 + size200;
  ...
  static double size115 = size110 + size5;
  static double size120 = size110 + size10;
  static double size125 = size110 + size15;
  static double size130 = size125 + size5;
  static double size135 = size130 + size5;
  static double size140 = size130 + size10;
  static double size220 = screenHeight / 3.65454;
  static double size270 = size250 + size20;
